...
//#define HARMONY_PIN_ACCESS
#ifdef HARMONY_PIN_ACCESS

#define PIN_BACKLIGHT(X) SYS_PORTS_PinWrite (PORTS_ID_0, PORT_CHANNEL_C, PORTS_BIT_POS_9, X)
#define PIN__RESET(X) SYS_PORTS_PinWrite (PORTS_ID_0, PORT_CHANNEL_C, PORTS_BIT_POS_8, X)
#define PIN_A0(X) SYS_PORTS_PinWrite (PORTS_ID_0, PORT_CHANNEL_C, PORTS_BIT_POS_7, X)
#define PIN_SDA(X) SYS_PORTS_PinWrite (PORTS_ID_0, PORT_CHANNEL_C, PORTS_BIT_POS_6, X)
#define PIN_SCLK(X) SYS_PORTS_PinWrite (PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_9, X)
#define PIN__CS(X) SYS_PORTS_PinWrite (PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_8, X)
...
#define PIN_BACKLIGHT(X) LATCbits.LATC9 = X
#define PIN__RESET(X) LATCbits.LATC8 = X
#define PIN_A0(X) LATCbits.LATC7 = X
#define PIN_SDA(X) LATCbits.LATC6 = X
#define PIN_SCLK(X) LATBbits.LATB9 = X
#define PIN__CS(X) LATBbits.LATB8 = X
#define PIN_DC(X) LATCbits.LATC7 = X 
#define PIN_SDIN(X) LATCbits.LATC6 = X
#define PIN_SCE(X) LATBbits.LATB8 = X 
